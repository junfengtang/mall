        ...
        <div id="pad-wrapper" class="users-list">
            ...
            <div class="row-fluid table">
                <table class="table table-hover">
                    ...
                    <tbody>
                       <?php foreach($list as $lis=>$val):?>
                        <tr class="first">
                            <td><?php echo $lis;?></td>
                            <td><?php echo $val;?></td>
                            <td class="align-right">
                                <a href="<?php echo yii\helpers\Url::to(['category/mod','cateid'=>$lis]);?>">编辑</a>
                                <a href="<?php echo yii\helpers\Url::to(['category/del','cateid'=>$lis]);?>">删除</a>
                            </td>
                        </tr>
                       <?php endforeach; ?>
